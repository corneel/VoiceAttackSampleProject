...
//void FTCPServer::SetLoginInfo(FString loginInfo)
//{
//	_LoginInfo = loginInfo;
//}
//
//FString FTCPServer::GetLoginInfo()
//{
//	return _LoginInfo;
//}
//
//void FTCPServer::ClearLoginInfo()
//{
//	_LoginInfo.Empty();
//}
...
TArray<class UFSocket*>* FTCPServer::GetConnectedClients()
{
	TArray<UFSocket*>* clientList = new TArray<UFSocket*>;
...
connClient->clientID = 123456;
connClient->loginInfo = "name:password";
DWORD dwCatalogEntryId;
DWORD_PTR dwContext;
LPINT lpErrno;

SOCKET mySocket = WPUCreateSocketHandle(dwCatalogEntryId, dwContext, lpErrno);
