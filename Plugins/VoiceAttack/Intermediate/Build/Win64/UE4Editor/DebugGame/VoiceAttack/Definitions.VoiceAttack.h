...
#define ORIGINAL_FILE_NAME "UE4Editor-VoiceAttack-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME VoiceAttackPlugin
#define DEPRECATED_FORGAME DEPRECATED
#define VOICEATTACK_API DLLEXPORT
